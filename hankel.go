...
type HankelTransform struct {
	...
	JR, JV                            mat.VecDense
	order                             int
	maxRadius, vMax                   float64
	nPoints                           int
	originalRadialGrid, originalKGrid mat.Vector
	r, kr, v                          mat.VecDense
	alpha                             mat.Vector
	alpha_n1, S                       float64
}
...
func (h *HankelTransform) IQDHT(fv mat.Vector) mat.Vector {
	...
	*/
	...
	//      return fr
	jr, jv := h.getScalingFactors(fv)
	n, _ := fv.Dims()
	fv_ := mat.NewVecDense(n, nil)
	fv_.DivElemVec(fv, jv)

	// frMat := mat.NewDense(h.nPoints, h.nPoints, nil)
	// frMat.Mul(&(h.T), fv_)
...
func (t *HankelTransform) ToTransformR(function mat.Vector) mat.Vector {
	...
	*/
	...
	// axis = 0
	// }
	return utils.Spline(t.originalRadialGrid, function, &t.r)
}
...
func (t *HankelTransform) ToOriginalR(function mat.Vector) mat.Vector {
	...
	*/
	...
	// axis = 0
	// }
	return utils.Spline(&t.r, function, t.originalRadialGrid)
}
func (t *HankelTransform) ToTransformK(function mat.Vector) mat.Vector {
	...
	*/
	...
	// axis = 0
	// }
	return utils.Spline(t.originalKGrid, function, &t.kr)
}
...
func (t *HankelTransform) ToOriginalK(function mat.Vector) mat.Vector {
	...
	*/
	...
	// axis = 0
	// }
	return utils.Spline(&t.kr, function, t.originalKGrid)
}
